...
#define GATT_CSC_CONTROL_POINT_CHAR_UUID 0x2A55     //write, indicate  
...
void ble_init(void);
void ble_notify_data(uint32_t, uint16_t, uint16_t, uint16_t);
void ble_notify_short_data(uint32_t, uint16_t);
